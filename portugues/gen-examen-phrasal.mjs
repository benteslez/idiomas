// Pipeline del tema "expresiones / modismos" del examen Lexis PT.
...
const js = "// Tema 'expresiones / modismos' del examen Lexis PT — generado por gen-examen-phrasal.mjs\n" +
...
console.log("=== Lexis PT · expresiones ===");
