// Pipeline de los ejercicios "con frase" del examen Lexis PT:
...
const out = "// Ejercicios con frase del examen Lexis PT — generado por gen-examen-extra.mjs\n" +
  "window.LEXIS_RICH = " + JSON.stringify({ gap, syn, traps }) + ";\n";
writeFileSync(here("./examen-extra.js"), out, "utf8");
console.log("=== Lexis PT · ejercicios con frase ===");
