...
(function(){
  ...
  const STATE_KEY     = 'parcours_b2_state';
  const SCORES_KEY    = 'parcours_b2_scores';
  const DRAFTS_KEY    = 'parcours_b2_drafts';
  const PE_KEY        = 'parcours_b2_pe_done';
  const CHECKLIST_KEY = 'parcours_b2_checklist';
  const ERRORS_KEY    = 'parcours_b2_errors';
...
/* ═══════════════════════════════════════════════════════════════
   SUPABASE CLOUD SYNC MODULE (parcours_b2)
   ═══════════════════════════════════════════════════════════════ */
(function(){
  'use strict';

  const APP_ID       = 'parcours_b2';
  ...
  const LS_STATE     = 'parcours_b2_state';
  const LS_SCORES    = 'parcours_b2_scores';
  const LS_DRAFTS    = 'parcours_b2_drafts';
  const LS_PE        = 'parcours_b2_pe_done';
  const LS_CHECKLIST = 'parcours_b2_checklist';
  const LS_ACTIVITY  = 'parcours_b2_activity';
  const LS_SRS       = 'parcours_b2_srs';
  const LS_ERRORS    = 'parcours_b2_errors';
  const LS_CALIB     = 'parcours_b2_calibration';
